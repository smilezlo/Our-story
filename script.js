...
<br><br>
Остался последний шаг, выбрать день, место нашей встречи.
<br>
...
let showTimer;
    ...
    show("Хочется...<br>чтобы наша история продолжилась уже не на экране телефона...<br>прежде, чем ты пойдешь дальше хочу сказать тебе...");
